                ...
                <div className='blcok-profile'>
                    <div className='content-profile'>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <input className='number-phone' type="text" placeholder='กรุณากรอก เบอร์โทรศัพท์....' />
                        </div>
                        <div className='flex flex-col'>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <input className='email' type="text" value={"65022403@up.ac.th"} />
                        </div>
                        <div className='flex flex-col'>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <input className='start-intern' type="text" value={"1 พศ. 2567"} />
                        </div>
                        <div className='flex flex-col'>
                            <label htmlFor="end-intern" className='title-email'>วันที่เลิกฝึกงาน</label>
                            <input className='end-intern' type="text" value={"30 กย. 2568"} />
                        </div>
                    </div>
