                    ...
                    <div className='form-box flex'>
                        <div className='LogoUP flex justify-between'>
                            ...
                            <p className='right-top'>
                                <span>คณะเทคโนโลยีสารสนเทศและการสื่อสาร</span> <br />
                                มหาวิทยาลัยพะเยา <br />
                        ...
                        <div className='content-form'>
                            ...
                            <p className='paragraph'>
                                <span>ในการนี้ คณะเทคโนโลยีสารสนเทศและการสื่อสาร นาย ธเนศ วงเดือน นิสิต สาขาวิศวกรรมซอฟต์แวร์ คณะเทคโนโลยีสารสนเทศและการสื่อสาร เข้าฝึกประสบการณ์ด้านวิชาชีพ ระยะเวลาการฝึกปฏิบัติ
                                1 เมษายน 2567 ถึง 31 พฤษภาคม 2567 </span>
                                ทางด้านวิชาชีพ ทั้งนี้ มอบหมายให้ {formData.fullname} ตำแหน่ง {formData.position}
                            ...
                            <div className='low-test'>
                                <p>งานวิชาการ <span>คณะเทคโนโลยีสารสนเทศและการสื่อสาร</span></p>
